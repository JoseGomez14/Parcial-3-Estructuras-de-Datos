...
## **💻 Ejecución:**
  ...
  - **Resultados**
    - Punto 1:
      - ```/1/sortedAddresses.js```
      - ```/1/sortedAddressesByPostalCode.js```
...
- **💡 Estrategia:**
  ...
  - Luego se decidió calcular las distancias usando la **distancia ecuclidiana** basadas en sus ubicaciones geograficas (Latitud y Longitud).
    
    **Nota:** *La información acerca de la latitud y longitud se puede obtner através de [Geocodings API de Google Maps](https://developers.google.com/maps/documentation/geocoding?hl=es-419)*
   <div align="center">
  ...
  - En vista de que puntos opuestos pueden tener el mismo valor en distancia, se adicinó información acerca del código postal que divide los mapas en reiones y así tener segmentado el conjunto de ubicaciones que se encuentran en cada región
...
- **✅ Resultado:**
    ...
    ```
    [Ver conjunto de datos ordenado - completo](/1/sortedAddresses.js)
